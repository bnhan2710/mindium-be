...
export class GoogleIdentityBroker implements IOAuthProvider {
	...
	constructor(private readonly envFactory: EnvironmentKeyFactory) {
		this.clientId = this.envFactory.getGoogleOAuthConfig().clientId;
		this.clientSecret = this.envFactory.getGoogleOAuthConfig().clientSecret;
		this.redirectUrl = this.envFactory.getGoogleOAuthConfig().redirectUrl;
	}
